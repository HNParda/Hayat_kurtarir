...
public class test {
     ...
     */
    public test setCaptureActivity(Class<?> captureActivity) {
     ...
     * @return this
     */
    public test setRequestCode(int requestCode) {
     ...
     *                 of an {@link Activity}
     */
    public static test forSupportFragment(androidx.fragment.app.Fragment fragment) {
        test integrator = new test(fragment.getActivity());
    ...
    public static test forFragment(Fragment fragment) {
        test integrator = new test(fragment.getActivity());
    ...
    public final test addExtra(String key, Object value) {
     ...
     */
    public final test setPrompt(String prompt) {
        if (prompt != null) {
     ...
     */
    public test setOrientationLocked(boolean locked) {
     ...
     * @return this
     */
    public test setCameraId(int cameraId) {
        if (cameraId >= 0) {
     ...
     * @return this
     */
    public test setTorchEnabled(boolean enabled) {
     ...
     * @return this
     */
    public test setBarcodeImageEnabled(boolean enabled) {
     ...
     * @return this
     */
    public test setDesiredBarcodeFormats(Collection<String> desiredBarcodeFormats) {
     ...
     * @return this
     */
    public test setDesiredBarcodeFormats(String... desiredBarcodeFormats) {
     ...
     */
    public test setTimeout(long timeout) {
     ...
     * else an {@link test2} containing the result of the scan. If the user cancelled scanning,
     * the fields will be null.
     */
    public static test2 parseActivityResult(int requestCode, int resultCode, Intent intent) {
     ...
     * @param resultCode result code from {@code onActivityResult()}
     * @param intent     {@link Intent} from {@code onActivityResult()}
     * @return an {@link test2} containing the result of the scan. If the user cancelled scanning,
     * the fields will be null.
     */
    public static test2 parseActivityResult(int resultCode, Intent intent) {
